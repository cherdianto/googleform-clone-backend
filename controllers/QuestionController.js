...
export const addQuestion = asyncHandler(async (req, res) => {
  ...
  // create blank question, why? because it is autosave
  const newQuestion = {
...
export const updateQuestion = asyncHandler(async (req, res) => {
  ...
  //   check the req.body whether containing one of question, type or required.
  // using else if because the API only accept 1 parameter of change, autosave
