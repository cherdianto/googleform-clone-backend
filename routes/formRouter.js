...
import { createForm, showForm, showForms, deleteForm, updateForm, showToUser } from '../controllers/formController.js'
import { addOption, deleteOption, updateOption } from '../controllers/OptionController.js'
...
router.post('/:formId/questions/:questionId/options/:optionId', verifyToken, updateOption)
router.delete('/:formId/questions/:questionId/options/:optionId', verifyToken, deleteOption)
// router.delete('/:formId/questions/:questionId', verifyToken, deleteQuestion)
